...
class gui():
	...
	def game_over(self):
		self.window.after(50, self.destroy_board_widgets)
		self.window.after(50, self.destroy_game_widgets)
		...
		self.window.after(2100, self.homepage)
